...
After installation, run `npm install` and then run `npm run watch` which will open up a preview of the template in your default browser, watch for changes to core template files, and live reload the browser when changes are saved. Using Yarn is more recommended.
